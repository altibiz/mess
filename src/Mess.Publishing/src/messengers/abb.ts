...
export const push: Create = async (template) => {
  const data = {
    ...
    activePowerImportL1_Wh: (Math.random() * 1000).toFixed(0),
    activePowerImportL2_Wh: (Math.random() * 1000).toFixed(0),
    activePowerImportL3_Wh: (Math.random() * 1000).toFixed(0),
    activePowerExportL1_Wh: (Math.random() * 1000).toFixed(0),
    activePowerExportL2_Wh: (Math.random() * 1000).toFixed(0),
    activePowerExportL3_Wh: (Math.random() * 1000).toFixed(0),
    reactivePowerImportL1_VARh: (Math.random() * 1000).toFixed(0),
    reactivePowerImportL2_VARh: (Math.random() * 1000).toFixed(0),
    reactivePowerImportL3_VARh: (Math.random() * 1000).toFixed(0),
    reactivePowerExportL1_VARh: (Math.random() * 1000).toFixed(0),
    reactivePowerExportL2_VARh: (Math.random() * 1000).toFixed(0),
    reactivePowerExportL3_VARh: (Math.random() * 1000).toFixed(0),
