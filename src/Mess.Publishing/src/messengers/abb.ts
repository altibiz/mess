...
export const push: Create = async (template) => {
  const data = {
    voltageL1_V: (Math.random() * 100000).toFixed(0),
    voltageL2_V: (Math.random() * 100000).toFixed(0),
    voltageL3_V: (Math.random() * 100000).toFixed(0),
    currentL1_A: (Math.random() * 100000).toFixed(0),
    currentL2_A: (Math.random() * 100000).toFixed(0),
    currentL3_A: (Math.random() * 100000).toFixed(0),
    activePowerL1_W: (Math.random() * 100000).toFixed(0),
    activePowerL2_W: (Math.random() * 100000).toFixed(0),
    activePowerL3_W: (Math.random() * 100000).toFixed(0),
    reactivePowerL1_VAR: (Math.random() * 100000).toFixed(0),
    reactivePowerL2_VAR: (Math.random() * 100000).toFixed(0),
    reactivePowerL3_VAR: (Math.random() * 100000).toFixed(0),
