    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.Sql("""
        ...
        select
            ...
            avg("VoltageL1Avg_V") as "VoltageL1Avg_V",
            avg("VoltageL2Avg_V") as "VoltageL2Avg_V",
            avg("VoltageL3Avg_V") as "VoltageL3Avg_V",
            avg("CurrentL1Avg_A") as "CurrentL1Avg_A",
            avg("CurrentL2Avg_A") as "CurrentL2Avg_A",
            avg("CurrentL3Avg_A") as "CurrentL3Avg_A",
            avg("ActivePowerL1Avg_W") as "ActivePowerL1Avg_W",
            avg("ActivePowerL2Avg_W") as "ActivePowerL2Avg_W",
            avg("ActivePowerL3Avg_W") as "ActivePowerL3Avg_W",
            avg("ReactivePowerTotalAvg_VAR") as "ReactivePowerTotalAvg_VAR",
            avg("ApparentPowerTotalAvg_VA") as "ApparentPowerTotalAvg_VA",
      ...
      migrationBuilder.Sql("""
        ...
        select
            ...
            avg("ActivePowerL2Avg_W") as "ActivePowerL2Avg_W",
            avg("ActivePowerL3Avg_W") as "ActivePowerL3Avg_W",
            avg("ReactivePowerL1Avg_VAR") as "ReactivePowerL1Avg_VAR",
            avg("ReactivePowerL2Avg_VAR") as "ReactivePowerL2Avg_VAR",
            avg("ReactivePowerL3Avg_VAR") as "ReactivePowerL3Avg_VAR",
            min("ActiveEnergyImportTotal_Wh") as "ActiveEnergyImportTotalMin_Wh",
            max("ActiveEnergyImportTotal_Wh") as "ActiveEnergyImportTotalMax_Wh",
            min("ActiveEnergyExportTotal_Wh") as "ActiveEnergyExportTotalMin_Wh",
            max("ActiveEnergyExportTotal_Wh") as "ActiveEnergyExportTotalMax_Wh",
