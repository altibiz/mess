...
public class AbbMonthlyAggregateEntity : MonthlyContinuousAggregateEntity
{
...
public static class AbbMonthlyAggregateEntityExtensions
{
  public static AbbMonthlyAggregateEntity ToMonthlyAggregateEntity(
    this AbbMeasurement measurement,
    string tenant
  )
  {
    return new AbbMonthlyAggregateEntity
    {
      Tenant = tenant,
  ...
  public static List<AbbMonthlyAggregateEntity> Upsert(
    ...
    AbbMonthlyAggregateEntity next
  ) =>
    previous.Timestamp == next.Timestamp ?
    new()
    {
      new AbbMonthlyAggregateEntity
      {
  ...
  public static readonly Expression<Func<AbbMonthlyAggregateEntity, AbbMonthlyAggregateEntity, AbbMonthlyAggregateEntity>>
  UpsertRow = (
    AbbMonthlyAggregateEntity previous,
    AbbMonthlyAggregateEntity next
  ) =>
    new AbbMonthlyAggregateEntity
    {
  ...
  public static AbbAggregate ToModel(
    this AbbMonthlyAggregateEntity entity
  )
  {
