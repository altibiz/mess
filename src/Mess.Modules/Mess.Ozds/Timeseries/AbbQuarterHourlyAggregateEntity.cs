...
public class AbbQuarterHourlyAggregateEntity : QuarterHourlyContinuousAggregateEntity
{
  ...
  [Column(TypeName = "float8")]
  public decimal ReactivePowerL1Avg_VAR { get; set; } = default!;

  [Column(TypeName = "float8")]
  public decimal ReactivePowerL2Avg_VAR { get; set; } = default!;

  [Column(TypeName = "float8")]
  public decimal ReactivePowerL3Avg_VAR { get; set; } = default!;
...
public static class AbbQuarterHourlyAggregateEntityExtensions
{
  public static AbbQuarterHourlyAggregateEntity ToQuarterHourlyAggregateEntity(
    this AbbMeasurement measurement,
    string tenant
  )
  {
    return new AbbQuarterHourlyAggregateEntity
    {
      Tenant = tenant,
      ...
      ReactivePowerL1Avg_VAR = measurement.ReactivePowerL1_VAR,
      ReactivePowerL2Avg_VAR = measurement.ReactivePowerL2_VAR,
      ReactivePowerL3Avg_VAR = measurement.ReactivePowerL3_VAR,
  ...
  public static List<AbbQuarterHourlyAggregateEntity> UpsertRange(
    this IEnumerable<AbbQuarterHourlyAggregateEntity> aggregates
  )
  {
  ...
  public static List<AbbQuarterHourlyAggregateEntity> Upsert(
    this AbbQuarterHourlyAggregateEntity previous,
    AbbQuarterHourlyAggregateEntity next
  )
  {
      ...
      new List<AbbQuarterHourlyAggregateEntity>()
      {
        new AbbQuarterHourlyAggregateEntity
        {
          ...
          ReactivePowerL1Avg_VAR =
            (previous.ReactivePowerL1Avg_VAR * previous.AggregateCount
              + next.ReactivePowerL1Avg_VAR * next.AggregateCount)
              / (previous.AggregateCount + next.AggregateCount),
          ReactivePowerL2Avg_VAR =
            (previous.ReactivePowerL2Avg_VAR * previous.AggregateCount
              + next.ReactivePowerL2Avg_VAR * next.AggregateCount)
              / (previous.AggregateCount + next.AggregateCount),
          ReactivePowerL3Avg_VAR =
            (previous.ReactivePowerL3Avg_VAR * previous.AggregateCount
              + next.ReactivePowerL3Avg_VAR * next.AggregateCount)
              / (previous.AggregateCount + next.AggregateCount),
  ...
  UpsertRow = (
    AbbQuarterHourlyAggregateEntity previous,
    AbbQuarterHourlyAggregateEntity next
  ) =>
    new AbbQuarterHourlyAggregateEntity
    {
  ...
  public static AbbAggregate ToModel(
    this AbbQuarterHourlyAggregateEntity entity
  )
  {
    return new AbbAggregate(
      entity.Source,
      entity.Timestamp,
      entity.TimeSpan,
      ...
      entity.ReactivePowerL1Avg_VAR,
      entity.ReactivePowerL2Avg_VAR,
      entity.ReactivePowerL3Avg_VAR,
