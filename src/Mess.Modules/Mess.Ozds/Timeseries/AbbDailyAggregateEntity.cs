...
public class AbbDailyAggregateEntity : DailyContinuousAggregateEntity
{
...
public static class AbbDailyAggregateEntityExtensions
{
  public static AbbDailyAggregateEntity ToDailyAggregateEntity(
    this AbbMeasurement measurement,
    string tenant
  )
  {
    return new AbbDailyAggregateEntity
    {
      Tenant = tenant,
  ...
  public static readonly Expression<Func<AbbDailyAggregateEntity, AbbDailyAggregateEntity, AbbDailyAggregateEntity>>
  UpsertRow = (
    AbbDailyAggregateEntity previous,
    AbbDailyAggregateEntity next
  ) =>
    new AbbDailyAggregateEntity
    {
  ...
  public static AbbAggregate ToModel(
    this AbbDailyAggregateEntity entity
  )
  {
