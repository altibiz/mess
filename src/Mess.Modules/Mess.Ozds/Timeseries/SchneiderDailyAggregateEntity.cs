...
public class SchneiderDailyAggregateEntity : DailyContinuousAggregateEntity
{
...
{
  public static SchneiderDailyAggregateEntity ToDailyAggregateEntity(
    this SchneiderMeasurement measurement,
    string tenant
  )
  {
    return new SchneiderDailyAggregateEntity
    {
      Tenant = tenant,
  ...
  UpsertRow = (
    SchneiderDailyAggregateEntity previous,
    SchneiderDailyAggregateEntity next
  ) =>
    new SchneiderDailyAggregateEntity
    {
  ...
  public static SchneiderAggregate ToModel(
    this SchneiderDailyAggregateEntity entity
  )
  {
